                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="expense_search.php" method="POST">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td><a href="expense_list.php" class="btn btn-info">Back</a></td>
                                    </tr>
                                </table>
                            </form>
                            <table class="table table-bordered">
                            ...
                            $expenseSql = "SELECT expense_category.category, people.name, expense.* FROM expense JOIN expense_category ON expense.category_id = expense_category.id JOIN people ON expense.people_id = people.id WHERE expense.date  BETWEEN '$start_date' AND '$end_date'";
