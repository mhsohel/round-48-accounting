        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <?php 
                        $dr = $db->query("SELECT * FROM `transactions` JOIN account_heads on transactions.account_head_id=account_heads.id WHERE txn_type='debit'  ORDER by date ASC;");
                        $cr = $db->query("SELECT * FROM `transactions` JOIN account_heads on transactions.account_head_id=account_heads.id WHERE txn_type='credit'  ORDER by date ASC;");
                        $drAmount = 0;
                        $crAmount = 0;
                        $drDif = 0;
                        $crDif = 0;
                                     ...
                                     <tr>
                                         <td><table class="table table-bordered">
                                             <tr>
                                                 ...
                                                 <td></td>
                                                 <td class="text-right"><?php echo $crDif; ?></td>
                                             </tr>
                                         </table></td>
                                         <td><table class="table table-bordered">
                                             <tr>
                                                 ...
                                                 <td class="text-right"><?php echo $drDif; ?></td>
                                             </tr>
                                         </table></td>
                                     </tr>
                                    <tr>
