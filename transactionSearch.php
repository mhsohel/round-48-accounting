                    ...
                    <div class="row">
                        <!-- contents goes here  -->
                          <div class="col-md-12 col-xl-12">
                                ...
                                $transData = $db->query("SELECT people.name as peopleName,people.id as peopleID,account_heads.id as aID, account_heads.name as accountHadesName, transactions.note, transactions.txn_type,transactions.amount,transactions.date,transactions.id FROM `transactions` JOIN account_heads on transactions.account_head_id=account_heads.id JOIN people on transactions.people_id= people.id WHERE transactions.date BETWEEN '$startDate' AND '$endDate' ORDER BY transactions.date DESC");
                                ...
                                <a href="transactions.php" class="btn btn-success">Add Transaction</a>
                                   ...
                                   <form action="transactionSearch.php" method="POST">
                                       <table class="table table-bordered">
                                           <tr>
                                               <th>Start Date</th>
                                               <td><input type="date" name="startDate" class="form-control" value="<?php echo $startDate ?>"></td>
                                               <th>End Date</th>
                                               <td><input type="date" name="endDate" class="form-control" value="<?php echo $endDate ?>"></td>
